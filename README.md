...
This project has been forked and modernized to work with **Angular 19+** using the new **Signals API**. The component has been completely refactored to use Angular's modern reactive primitives for better performance and developer experience.
...
All properties are now **signal-based inputs** for improved performance and reactivity.
...
**Note:** Property names now use camelCase only. Backward compatibility with kebab-case names has been removed.
